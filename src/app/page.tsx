  ...
  return (
    <>
      ...
      <main className={cn(
        ...
        <iframe data-aa='2377679' src='//acceptable.a-ads.com/2377679' style={{border: '0px', padding: 0, width: '100%', height: '20%', overflow: 'hidden', backgroundColor: 'transparent'}}></iframe>
