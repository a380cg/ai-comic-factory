  ...
  return (
    <>
      ...
      <main className={cn(
        ...
        <iframe data-aa='2377679' src='//acceptable.a-ads.com/2377679' style='border:0px; padding:0; width:100%; height:100%; overflow:hidden; background-color: transparent;'></iframe>
